...
- **Android APK** (사이드로드): [Releases](https://github.com/funexcloud/balmi/releases)에서 **`balmi-0.1.2.apk`**(32/64비트 통합)를 받아 설치합니다. 대부분의 최신 폰은 `balmi-0.1.2-arm64-v8a.apk`만 받아도 됩니다. 휴대폰에서 **알 수 없는 출처** 설치를 허용해야 합니다.
